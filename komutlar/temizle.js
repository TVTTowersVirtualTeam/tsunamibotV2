...
kanal.send(öneri + ' **💾 Temizle Komutu kullanıldı.** ' + message.author.tag + ' - ' + message.channel.name)
    if (isNaN(args)) return message.reply('**:no_entry:  Temizle komutunu kullanabilmek için lütfen geçerli bir sayı giriniz!**');
